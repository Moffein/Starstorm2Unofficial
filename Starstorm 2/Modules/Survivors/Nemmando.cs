    ...
    internal class Nemmando : SurvivorBase
    {
        ...
        internal override void InitializeCharacter()
        {
            ...
            if (characterEnabled.Value)
            {
                ...
                bodyPrefab.GetComponent<EntityStateMachine>().initialStateType = new SerializableEntityStateType(typeof(Cores.States.Generic.NemmandoSpawnState));
        ...
        internal override void InitializeSkills()
        {
            ...
            #region Primary
            SkillDef m1SkillDef = Modules.Skills.CreatePrimarySkillDef(new SerializableEntityStateType(typeof(Cores.States.Nemmando.BladeOfCessation2)), "Weapon", "NEMMANDO_PRIMARY_BLADE_NAME", "NEMMANDO_PRIMARY_BLADE_DESCRIPTION", Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texBladeOfCessation"), true);
            ...
            SkillDef gashSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ChargeSwordBeam)),
            ...
            SkillDef gunSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ShootGun)),
            ...
            SkillDef submissionSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSubmission"),
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ChargeBarrage.ChargeBarrageCharge)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
            ...
            decisiveStrikeSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ChargedSlashCharge)),
                activationStateMachineName = "Body",
                baseMaxStock = 1,
                baseRechargeInterval = 12f,
                beginSkillCooldownOnSkillEnd = true,
        ...
        private static void SetupScepterSkills()
        {
            scepterSubmissionSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ScepterBarrage.ScepterBarrageCharge)),
                activationStateMachineName = "Slide",
                baseMaxStock = 1,
                baseRechargeInterval = 12f,
                beginSkillCooldownOnSkillEnd = true,
            ...
            scepterDecisiveStrikeSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new SerializableEntityStateType(typeof(Cores.States.Nemmando.ScepterSlashCharge)),
                activationStateMachineName = "Body",
                baseMaxStock = 1,
                baseRechargeInterval = 12f,
                beginSkillCooldownOnSkillEnd = true,
