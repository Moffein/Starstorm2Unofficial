...
namespace Starstorm2.Modules
{
    internal static class Skills
    {
        ...
        {
            AddPrimarySkill(targetPrefab, skillDef, null);
        }
        ...
        {
            AddSecondarySkill(targetPrefab, skillDef, null);
        }
        ...
        {
            AddUtilitySkill(targetPrefab, skillDef, null);
        }
        ...
        {
            AddSpecialSkill(targetPrefab, skillDef, null);
        }
