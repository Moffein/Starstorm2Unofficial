...
namespace Starstorm2Unofficial.Cores.Items
{
    ...
    {
        public override string NameInternal => "Coffee";
        public override string Name => "Coffee Bag";
        public override string Pickup => "Move and attack faster.";
        public override string Description => $"Increase your movement speed by <style=cIsUtility>{StaticValues.coffeeMoveSpeedValue * 100f}%</style> <style=cStack>(+{StaticValues.coffeeMoveSpeedValue * 100f}% per stack)</style> and your attack speed by <style=cIsDamage>{StaticValues.coffeeAttackSpeedValue * 100f}%</style> <style=cStack>(+{StaticValues.coffeeAttackSpeedValue * 100f}% per stack)</style>.";
        ...
        private void CharacterBody_RecalculateStats(On.RoR2.CharacterBody.orig_RecalculateStats orig, CharacterBody self)
        {
            ...
            self.moveSpeed += self.baseMoveSpeed * StaticValues.coffeeMoveSpeedValue * coffeeCount;
            self.attackSpeed += self.baseAttackSpeed * StaticValues.coffeeAttackSpeedValue * coffeeCount;
        }
    }
}