        ...
        public virtual void FireBeam()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.swordBeam, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), base.gameObject, damage, 0f, base.RollCrit(), DamageColorIndex.Default, null, this.projectileSpeed);
                }
            }
        }
