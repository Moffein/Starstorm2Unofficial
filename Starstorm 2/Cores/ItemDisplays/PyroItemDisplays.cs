...
namespace Starstorm2.Cores.ItemDisplays
{
    public static class PyroItemDisplays
    {
        ...
        public static void RegisterDisplays()
        {
            ...
            itemRules.Add(ItemDisplayCore.CreateGenericDisplayRule(RoR2Content.Items.CooldownOnCrit, "DisplaySkull", "Chest", new Vector3(-0.001f, 0.008f, 0), new Vector3(90, 180, 0), new Vector3(0.005f, 0.005f, 0.005f)));
            ...
            itemRules.Add(ItemDisplayCore.CreateGenericDisplayRule(RoR2Content.Items.Incubator, "DisplayAncestralIncubator", "Chest", new Vector3(-0.0007f, 0.0015f, -0.002f), new Vector3(0f, 0f, 160f), new Vector3(0.0003f, 0.0003f, 0.0003f)));
