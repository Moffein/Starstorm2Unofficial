    ...
    public class FireIrradiateOvercharge : BaseState
    {
        public override void OnEnter()
        {
            ...
            if (base.isAuthority)
            {
                ...
                ProjectileManager.instance.FireProjectile(projectilePrefab, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), base.gameObject, this.damageStat * damageCoefficient, force, base.RollCrit(), DamageColorIndex.Default, null, -1f);
            }
        }
        ...
        public static float minDamageCoefficient = 9f;
