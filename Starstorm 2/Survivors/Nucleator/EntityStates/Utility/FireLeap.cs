    ...
    public class FireLeap : BaseCharacterMain
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.isAuthority)
            {
                if (base.characterMotor)
                {
                    ...
                    if (passedMinDuration && Starstorm2Unofficial.SneedUtils.IsEnemyInSphere(2.5f, base.transform.position, base.GetTeam(), false)) detonateNextFrame = true;
        ...
        protected virtual void DetonateAuthority()
        {
            ...
            BlastAttack ba = new BlastAttack
            {
                ...
                damageType = (DamageTypeCombo) DamageType.Stun1s | DamageSource.Utility | DamageTypeExtended.Electrical,
